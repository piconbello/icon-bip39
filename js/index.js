(function () {
    ...
    function TableRow(index, isLast) {
        ...
        function calculateValues() {
            setTimeout(function () {
                ...
                if ((networks[DOM.network.val()].name == "ICX - ICON Foundation")) {
                    var privKeyBuffer = keyPair.d.toBuffer(32);
                    privkey = privKeyBuffer.toString('hex');

                    address = ethUtil.getIcxPublicAddress(privkey);

                    pubkey = ethUtil.getIcxPublicKey(privkey);
    ...
    function addAddressToList(indexText, address, pubkey, privkey) {
        ...
        // Elements
        var indexCell = row.find(".index.col-md-2 span");
        var addressCell = row.find(".address.col-md-2 span");
        var pubkeyCell = row.find(".pubkey.col-md-4 span");
        var privkeyCell = row.find(".privkey.private-data.col-md-4 span");
        // Content
